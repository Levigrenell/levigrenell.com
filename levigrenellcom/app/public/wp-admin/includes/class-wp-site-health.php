...
class WP_Site_Health {
	...
	public function get_test_php_version() {
		...
		$result = array(
			...
			'actions'     => sprintf(
				'<p><a href="%s" target="_parent">%s<span class="screen-reader-text"> %s</span><span aria-hidden="true" class="dashicons dashicons-external"></span></a></p>',
			...
			if ( wp_is_https_supported() ) {
				...
				if ( defined( 'WP_HOME' ) || defined( 'WP_SITEURL' ) ) {
					...
					if ( ! empty( $direct_update_url ) ) {
						$result['actions'] = sprintf(
							'<p class="button-container"><a class="button button-primary" href="%1$s" target="_parent">%2$s<span class="screen-reader-text"> %3$s</span><span aria-hidden="true" class="dashicons dashicons-external"></span></a></p>',
	...
	public function get_test_page_cache() {
		...
		$result = array(
			...
			'label'       => '',
			'actions'     => sprintf(
				'<p><a href="%1$s" target="_parent" rel="noreferrer">%2$s<span class="screen-reader-text"> %3$s</span><span aria-hidden="true" class="dashicons dashicons-external"></span></a></p>',
	...
	public function get_test_autoloaded_options() {
		...
		$result['actions'] = sprintf(
			...
			'<p><a target="_parent" href="%1$s">%2$s</a></p>',
